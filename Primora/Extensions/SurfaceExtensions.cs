...
namespace Primora.Extensions
{
    ...
    internal static class SurfaceExtensions
    {
        ...
        /// <param name="clear">Clear the entire surface</param>
        /// <returns></returns>
        internal static void ResizeToFitFontSize(this ScreenSurface surface, float fontSizeAdjustment, bool clear = false)
        {
            surface.FontSize = new Point(
                (int)(surface.Font.GlyphWidth * fontSizeAdjustment), 
                (int)(surface.Font.GlyphHeight * fontSizeAdjustment));
